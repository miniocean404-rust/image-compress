  ...
  <body>
    <script type="module">
      window.addEventListener("DOMContentLoaded", async () => {
        const { default: init } = await import("../dist/binding_wasm.js")
        ...
        // WebAssembly.instantiateStreaming(fetch("../dist/binding_wasm_bg.wasm"),__wbg_get_imports()).then((obj) => {
        //    obj.instance.exports.hello_world();
        // })

        // 2. 不通过流式调用，直接读取二进制文件并对字节进行实例化
        // fetch("../dist/binding_wasm_bg.wasm")
