...
impl Default for AvifOptions {
    fn default() -> Self {
        Self {
            // 质量 78: 视觉无损阈值，在人眼难以察觉差异的前提下最大化压缩
            // 研究表明 AVIF 在 quality 75-85 范围内人眼几乎无法察觉差异
            quality: 78.,
            // Alpha 通道质量 75: 透明通道对视觉影响较小，可以更激进压缩
            alpha_quality: Some(75.),
            // 速度 2: 更好的压缩率，编码时间适中
            // 速度 1 压缩率提升有限但时间大幅增加，速度 2 是较好的平衡点
            speed: 2,
