...
/// interlace: Option<bool>:             是否更改文件的交错类型。`None` 将不会更改当前的交错类型。`Some(true/false)` 将开启/关闭交错。默认值: `Some(false)`
/// optimize_alpha: bool:                是否允许更改透明像素以提高压缩率。默认值: `false`
...
/// max_decompressed_size: Option<usize>: 输入 IDAT 的最大解压大小。如果解压超过此大小，将被拒绝。默认值: `None`
